...
//*****************************************************************************
//カメラは複数あるとダメなので外す
static	ObjectModel2	g_Object2;		//3Dポリゴンオブジェクト構造体
...
HRESULT InitPolygonModel2(void)
{
	...
	//シェーダー読み込み
	CreateVertexShader(&g_VertexShader, &g_VertexLayout, "pointLightingVS.cso");
	CreatePixelShader(&g_PixelShader, "pointLightingPS.cso");
	...
	Light.Diffuse = XMFLOAT4(1.0f, 1.0f, 0.2f, 1.0f); //黄色
